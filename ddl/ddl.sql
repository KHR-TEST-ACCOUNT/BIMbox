...
CREATE TABLE TOPICS(
    ...
    CREATEDBY       bigint(9) unsigned zerofill NOT NULL,
...
CREATE TABLE POSTS (
    ...
    POST_IMG 		LONGBLOB DEFAULT NULL,
    CREATEDBY       bigint(9) unsigned zerofill NOT NULL,
    CREATEDAT       DATE DEFAULT NULL,
...
CREATE TABLE POST_RATINGS (
    ...
    RATEDBY         bigint(9) unsigned zerofill NOT NULL,
...
CREATE TABLE `MESSAGE_HIST` (
  ...
  `MESSAGE_IMG` LONGBLOB DEFAULT NULL,
