# [BIMbox](http://http://aws-and-communities.ap-northeast-1.elasticbeanstalk.com/Login.html)

   BIMboxはシェアハウスでのコミュニティ活性化をを目的としたWEBサイトです。<br>
   掲示板機能、ダイレクトメッセージ機能、ユーザー検索機能などがあり、今後もファイル共有機能やイベント機能、多言語対応機能など様々な機能を拡充していく予定です。<br>
   このサイトの特徴は自分のプロフィールに趣味を登録しておくと趣味に合致するユーザーをシステムがサジェストする事です。他のユーザーとはリアルタイムなダイレクトメッセージなども可能です。
